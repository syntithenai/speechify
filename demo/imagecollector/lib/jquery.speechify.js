		...
		init : function(options) {
			...
			function pauseRecognising() {
				...
				if (recognising) {
					...
					$('#speechify-status').html('<div class="microphone microphone-pause"><img src="images/microphonepause.png" />PAUSE</div>');
					$('.voice-help').hide();
			...
			function stopRecognising() {
				console.log('stop');
				if (recognising) {
					$('#speechify-status').html('<span class="microphone microphone-off"><img src="images/microphonepause.png" >OFF</span>');
					$('.voice-help').hide();
